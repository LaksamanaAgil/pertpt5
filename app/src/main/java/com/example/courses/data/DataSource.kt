...
object DataSource { //TODO: Memanggil gambar drawables dan resource string dan mengelompokkannya, serta menetapkan nilai available courses untuk kelompok yang ditetapkan
    val topics = listOf(
        Topic(R.string.architecture, 58, R.drawable.architecture), //TODO: Contohnya topik arsitektur dengan gambar yang relevan memiliki 58 available courses
